...
define('main',['exports', 'aurelia-i18n', 'aurelia-validation', './environment', 'i18next-xhr-backend'], function (exports, _aureliaI18n, _aureliaValidation, _environment, _i18nextXhrBackend) {
    ...
    function configure(aurelia) {
        ...
        aurelia.use.plugin('aurelia-animator-css').plugin('aurelia-configuration').plugin('aurelia-validation').plugin('aurelia-api', function (config) {
            config.registerEndpoint('api', '/ws/', {
...
define('features/views/view',['exports', 'aurelia-configuration', 'aurelia-api', 'aurelia-event-aggregator', 'aurelia-framework', 'aurelia-i18n', 'aurelia-router', 'uuid-js', 'features/utils'], function (exports, _aureliaConfiguration, _aureliaApi, _aureliaEventAggregator, _aureliaFramework, _aureliaI18n, _aureliaRouter, _uuidJs, _utils) {
  ...
  var View = exports.View = (_dec = (0, _aureliaFramework.inject)(_aureliaApi.Config, _aureliaConfiguration.AureliaConfiguration, _aureliaEventAggregator.EventAggregator, _aureliaI18n.I18N, _aureliaRouter.Router), _dec(_class = function () {
    function View(api, config, events, i18n, router) {
      ...
      this.uuid = _uuidJs2.default.create(4);
    }
    ...
    View.prototype.mergeSettings = function mergeSettings() {
...
define('model/user/user',['exports', 'features/views/model'], function (exports, _model) {
  'use strict';
...
define('components/helper/profile/profile',['exports', 'features/views/component'], function (exports, _component) {
    'use strict';

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.ComponentHelperProfile = undefined;
    ...
    var ComponentHelperProfile = exports.ComponentHelperProfile = function (_Component) {
        _inherits(ComponentHelperProfile, _Component);

        function ComponentHelperProfile() {
            var _temp, _this, _ret;

            _classCallCheck(this, ComponentHelperProfile);
            ...
            return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.defaultSettings = {
                ...
                service: {},
                services: {} }, _this.overrideSettingsKey = 'components.helper-profile', _temp), _possibleConstructorReturn(_this, _ret);
        }

        return ComponentHelperProfile;
    }(_component.Component);
});
define('components/nav/left/left',['exports', 'components/helper/content/content'], function (exports, _content) {
    'use strict';
...
define('text!app.html', ['module'], function(module) { module.exports = "<template><require from=\"bootstrap/css/bootstrap.min.css\"></require><require from=\"gentelella/css/custom.min.css\"></require><require from=\"app.css\"></require><div class=\"container body\"><div class=\"main_container\"><compose containerless view-model=\"components/nav/left/left\" model.bind=\"{}\"></compose><compose containerless view-model=\"components/nav/top/top\" model.bind=\"{}\"></compose><div class=\"right_col\" role=\"main\"><router-view></router-view></div><footer></footer></div></div></template>"; });
define('text!components/nav/nav.html', ['module'], function(module) { module.exports = "<template><ul class=\"nav\" class.bind=\"style\"><li repeat.for=\"route in routes\"><a route-href=\"{ route.bind: route.name, params.bind: route.params || {} }\">${route.title}</a></li></ul></template>"; });
define('text!templates/home/home.html', ['module'], function(module) { module.exports = "<template><h1>HOME!</h1></template>"; });
define('text!components/helper/content/content.html', ['module'], function(module) { module.exports = "<template><div class.bind=\"settings.layout\"><section><h1 t=\"[html]${settings.title}\" if.bind=\"settings.title\" class=\"policy__title\"></h1></section><section repeat.for=\"component of settings.components\" class=\"component component--${component.type}\" class.bind=\"settings.styles[component.type]\"><compose containerless view-model.bind=\"component.module\" model.bind=\"{ settings: component.settings }\"></compose></section></div></template>"; });
...
define('text!components/helper/logo/logo.html', ['module'], function(module) { module.exports = "<template><div class=\"navbar nav_title\" style=\"border:0\"><a href=\"index.html\" class=\"site_title\"><i class=\"fa fa-paw\"></i> <span>Am Skeleton!</span></a></div></template>"; });
define('text!components/helper/profile/profile.html', ['module'], function(module) { module.exports = "<template><div class=\"profile clearfix\"><div class=\"profile_pic\"><img src=\"images/img.jpg\" alt=\"...\" class=\"img-circle profile_img\"></div><div class=\"profile_info\"><span>Welcome,</span><h2>John Doe</h2></div></div></template>"; });
define('text!components/nav/left/left.html', ['module'], function(module) { module.exports = "<template><div class=\"col-md-3 left_col\"><div class=\"left_col scroll-view\"><div repeat.for=\"component of settings.components\" class=\"component component--${component.type}\" class.bind=\"settings.styles[component.type]\"><compose containerless view.bind=\"component.view || (component.module + '.html')\" view-model.bind=\"component.module\" model.bind=\"{ settings: component.settings }\"></compose><div class=\"clearfix\"></div></div></div></div></template>"; });
...
define('text!components/nav/top/top.html', ['module'], function(module) { module.exports = "<template><div class=\"top_nav\"><div class=\"nav_menu\"><nav><div class=\"nav toggle\"><a id=\"menu_toggle\" click.trigger=\"toggleLeftNav()\"><i class=\"fa fa-bars\"></i></a></div><ul class=\"nav navbar-nav navbar-right\"><li repeat.for=\"component of settings.components\" class=\"component component--${component.type}\" class.bind=\"settings.styles[component.type]\"><compose containerless view-model.bind=\"component.module\" model.bind=\"{ settings: component.settings }\"></compose></li></ul></nav></div></div></template>"; });
define('text!components/nav/top/inbox/inbox.html', ['module'], function(module) { module.exports = "<template><a href=\"javascript:;\" class=\"dropdown-toggle info-number\" data-toggle=\"dropdown\" aria-expanded=\"false\"><i class=\"fa fa-envelope-o\"></i> <span class=\"badge bg-green\">6</span></a><ul id=\"menu1\" class=\"dropdown-menu list-unstyled msg_list\" role=\"menu\"><li><a><span class=\"image\"><img src=\"images/img.jpg\" alt=\"Profile Image\"></span><span><span>John Smith</span> <span class=\"time\">3 mins ago</span> </span><span class=\"message\">Film festivals used to be do-or-die moments for movie makers. They were where...</span></a></li><li><a><span class=\"image\"><img src=\"images/img.jpg\" alt=\"Profile Image\"></span><span><span>John Smith</span> <span class=\"time\">3 mins ago</span> </span><span class=\"message\">Film festivals used to be do-or-die moments for movie makers. They were where...</span></a></li><li><a><span class=\"image\"><img src=\"images/img.jpg\" alt=\"Profile Image\"></span><span><span>John Smith</span> <span class=\"time\">3 mins ago</span> </span><span class=\"message\">Film festivals used to be do-or-die moments for movie makers. They were where...</span></a></li><li><a><span class=\"image\"><img src=\"images/img.jpg\" alt=\"Profile Image\"></span><span><span>John Smith</span> <span class=\"time\">3 mins ago</span> </span><span class=\"message\">Film festivals used to be do-or-die moments for movie makers. They were where...</span></a></li><li><div class=\"text-center\"><a><strong>See All Alerts</strong> <i class=\"fa fa-angle-right\"></i></a></div></li></ul></template>"; });
define('text!components/nav/top/user/user.html', ['module'], function(module) { module.exports = "<template><compose containerless view-model=\"model/user/user\" view=\"model/user/top-nav.html\"></compose><ul class=\"dropdown-menu dropdown-usermenu pull-right\"><li><a href=\"javascript:;\">Profile</a></li><li><a href=\"javascript:;\"><span class=\"badge bg-red pull-right\">50%</span> <span>Settings</span></a></li><li><a href=\"javascript:;\">Help</a></li><li><a href=\"login.html\"><i class=\"fa fa-sign-out pull-right\"></i> Log Out</a></li></ul></template>"; });
define('text!model/user/user.html', ['module'], function(module) { module.exports = "<template>TODO:</template>"; });
define('text!model/user/top-nav.html', ['module'], function(module) { module.exports = "<template><a href=\"javascript:;\" class=\"user-profile dropdown-toggle\" data-toggle=\"dropdown\" aria-expanded=\"false\"><img src.bind=\"image || 'images/img.jpg'\" alt=\"\"> ${name} <span class=\"fa fa-angle-down\"></span></a></template>"; });
define('text!model/user/left-profile.html', ['module'], function(module) { module.exports = "<template><div class=\"profile clearfix\"><div class=\"profile_pic\"><img src.bind=\"image || 'images/img.jpg'\" alt=\"...\" class=\"img-circle profile_img\"></div><div class=\"profile_info\"><span>Welcome,</span><h2>${name}</h2></div></div></template>"; });
