...
define('components/nav/nav',['exports', 'features/views/component', 'lodash'], function (exports, _component, _lodash) {
    ...
    var ComponentNav = exports.ComponentNav = function (_Component) {
        ...
        ComponentNav.prototype.activate = function activate() {
...
define('text!app.html', ['module'], function(module) { module.exports = "<template><require from=\"bootstrap/css/bootstrap.min.css\"></require><require from=\"app.css\"></require><nav-left class=\"col-md-2\"><compose containerless view-model=\"components/nav/left/left\"></compose></nav-left><content><nav-top><compose containerless view-model=\"components/nav/top/top\"></compose></nav-top><main-app><router-view></router-view></main-app><footer></footer></content></template>"; });
...
define('text!models/user/left-profile.html', ['module'], function(module) { module.exports = "<template><div class=\"profile clearfix\"><div class=\"profile_pic\"><img src.bind=\"image || 'images/img.jpg'\" alt=\"...\" class=\"img-circle profile_img\"></div><div class=\"profile_info\"><span>Welcome,</span><h2>${name}</h2></div></div></template>"; });
...
define('text!components/nav/left/left.html', ['module'], function(module) { module.exports = "<template><require from=\"components/nav/left/left.css\"></require><div repeat.for=\"component of settings.components\" class=\"component component--${component.type}\" class.bind=\"settings.styles[component.type]\"><compose containerless view.bind=\"component.view || (component.module + '.html')\" view-model.bind=\"component.module\" model.bind=\"{ settings: component.settings }\"></compose><div class=\"clearfix\"></div></div></template>"; });
