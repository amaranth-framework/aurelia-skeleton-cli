...
define('templates/tables/tables',['exports', 'features/views/template'], function (exports, _template) {
	...
	var TemplateTables = exports.TemplateTables = function (_Template) {
		...
		function TemplateTables() {
			...
			}, _this.overrideSettingsKey = 'templates.tables', _temp), _possibleConstructorReturn(_this, _ret);
		}
...
define('components/helper/table/table',['exports', 'features/views/component', 'chance'], function (exports, _component, _chance) {
  ...
  var ComponentHelperTable = exports.ComponentHelperTable = function (_Component) {
    ...
    ComponentHelperTable.prototype.activate = function activate() {
      ...
      (_Component$prototype$ = _Component.prototype.activate).call.apply(_Component$prototype$, [this].concat(args));
...
define('components/helper/page-title/page-title',['exports', 'features/views/component'], function (exports, _component) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.ComponentHelperPageTitle = undefined;
  ...
  var ComponentHelperPageTitle = exports.ComponentHelperPageTitle = function (_Component) {
    _inherits(ComponentHelperPageTitle, _Component);

    function ComponentHelperPageTitle() {
      var _temp, _this, _ret;

      _classCallCheck(this, ComponentHelperPageTitle);
    ...
    return ComponentHelperPageTitle;
  }(_component.Component);
});
define('components/nav/breadcrumb/breadcrumb',['exports', 'features/views/component', 'features/utils'], function (exports, _component, _utils) {
    'use strict';

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.ComponentNavBreadcrumb = undefined;
    ...
    var ComponentNavBreadcrumb = exports.ComponentNavBreadcrumb = function (_Component) {
        _inherits(ComponentNavBreadcrumb, _Component);

        function ComponentNavBreadcrumb() {
            var _temp, _this, _ret;

            _classCallCheck(this, ComponentNavBreadcrumb);
            ...
            return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.defaultSettings = {
                ...
                routes: [{ route: '' }],
                filter: {}
            }, _this.overrideSettingsKey = 'components.nav-breadcrumb', _temp), _possibleConstructorReturn(_this, _ret);
        }

        ComponentNavBreadcrumb.prototype.init = function init() {
            var _this2 = this;
            ...
            this.routes.forEach(function (route, i) {
                _this2.routes[i] = _this2.discoverRouteByName(route.route);
            });

            var tokens = this.router.currentInstruction.config.route.split('/');
            var route = '';
            while (tokens.length) {
                route += '/' + tokens.shift();
                var r = this.discoverRouteByName(route.substr(1));
                if (r) {
                    this.routes.push((0, _utils.extend)(true, r, {
            ...
            this.events.subscribe('components::breacrumbs::routes', function () {
                ...
                return _this2.routes;
            });
        };

        ComponentNavBreadcrumb.prototype.discoverRouteByName = function discoverRouteByName(route) {
            var r = _.find(this.router.routes, function (o) {
                return o.route == route || o.route.includes(route);
            });
            if (r.redirect) {
        ...
        ComponentNavBreadcrumb.prototype.filterParams = function filterParams(params, route) {
            var newParams = {};
        ...
        ComponentNavBreadcrumb.prototype.attached = function attached() {
            this.events.publish('components::breadcrumbs::attached', this.routes);
        };

        return ComponentNavBreadcrumb;
    }(_component.Component);
});
...
define('text!templates/tables/tables.html', ['module'], function(module) { module.exports = "<template><div class=\"container-fluid\"><div class=\"row\"><compose containerless view-model=\"components/helper/page-title/page-title\" model.bind=\"{ settings: settings.pageTitle }\"></compose></div></div><div class=\"container-fluid\"><div class=\"row\"><h3>Basic Table</h3><div class=\"col-md-12\"><form class=\"form-horizontal\"><div class=\"col-md-6\"><div class=\"form-group\"><label for=\"table-style-basic\" class=\"col-sm-2 control-label\">Table Style</label><div class=\"col-sm-10\"><select class=\"form-control\" id=\"table-style-basic\" value.bind=\"tableStyle\"><option value=\"\">none</option><option value=\"table-hover\">.table-hover</option><option value=\"table-bordered\">.table-bordered</option><option value=\"table-striped\">.table-striped</option><option value=\"table-responsive\">.table-responsive</option></select></div></div></div></form></div><div class=\"col-md-12\"><compose containerless view=\"components/helper/table/table.html\" view-model=\"components/demo/table/simple\" model.bind=\"{ settings: { style: tableStyle } }\"></compose></div></div></div></template>"; });
...
define('text!components/helper/table/table.html', ['module'], function(module) { module.exports = "<template><require from=\"./table.css\"></require><div class=\"table\"><div class=\"table-options\"><div if.bind=\"settings.export\" class=\"btn-toolbar table-export\" role=\"toolbar\"><div class=\"btn-group\" role=\"group\"><button type=\"button\" class=\"btn disabled\">Export as:</button> <button if.bind=\"settings.export.includes('csv')\" type=\"button\" class=\"btn\" click.trigger=\"exportToCSV()\">CSV</button> <button if.bind=\"settings.export.includes('xls')\" type=\"button\" class=\"btn\">Excel</button> <button if.bind=\"settings.export.includes('pdf')\" type=\"button\" class=\"btn\">PDF</button> <button if.bind=\"settings.export.includes('prt')\" type=\"button\" class=\"btn\">Print</button></div></div><form if.bind=\"settings.perpage\" class=\"form-inline table-perpage\"><div class=\"form-group\"><label for=\"table-perpage-${__uuid}\">Per page</label><select id=\"table-perpage-${__uuid}\"><option value=\"\">10</option><option value=\"\">20</option><option value=\"\">30</option></select></div></form><form if.bind=\"settings.sortby\" class=\"form-inline table-sortby\"><div class=\"form-group\"><label for=\"table-sortby-${__uuid}\">Sort by</label><select id=\"table-sortby-${__uuid}\"><option value=\"\">X</option><option value=\"\">Y</option><option value=\"\">Z</option></select></div></form><form if.bind=\"settings.tableStyle\" class=\"form-inline table-style\"><div class=\"form-style\"><label for=\"table-style-${__uuid}\">Style</label><select id=\"table-style-${__uuid}\"><option value=\"\">Stack</option><option value=\"\">Swipe</option><option value=\"\">Toggle</option></select></div></form><form if.bind=\"settings.search\" class=\"form-inline table-search\"><div class=\"form-group\"><label for=\"table-search-${__uuid}\">Search</label><input type=\"text\" class=\"form-control\" id=\"table-search-${__uuid}\" placeholder=\"Search\"></div></form></div><table class.bind=\"style\" id=\"table-${__uuid}\" class=\"table table--loading\"><caption if.bind=\"settings.content.caption\">${settings.content.caption}</caption><thead><tr><th repeat.for=\"label of thead\">${label}</th></tr></thead><tbody><tr repeat.for=\"row of tbody\"><th scope=\"row\">${row[0]}</th><td repeat.for=\"item of row.slice(1)\">${item}</td></tr></tbody></table><div if.bind=\"settings.pagination\" class=\"table-options\"><div class=\"btn-toolbar table-pagination pagination\" role=\"toolbar\" aria-label=\"Toolbar with button groups\"><div class=\"btn-group\" role=\"group\"><button type=\"button\" class=\"btn btn-secondary\"><i class=\"fa fa-angle-double-left\"></i></button> <button type=\"button\" class=\"btn btn-secondary\">1</button> <button type=\"button\" class=\"btn btn-info\">2</button> <button type=\"button\" class=\"btn btn-secondary\">3</button></div><div class=\"btn-group\" role=\"group\"><button type=\"button\" class=\"btn btn-secondary\">7</button> <button type=\"button\" class=\"btn btn-secondary\">8</button> <button type=\"button\" class=\"btn btn-secondary\">9</button></div><div class=\"btn-group\" role=\"group\"><button type=\"button\" class=\"btn btn-secondary\">7</button> <button type=\"button\" class=\"btn btn-secondary\">8</button> <button type=\"button\" class=\"btn btn-secondary\">9</button> <button type=\"button\" class=\"btn btn-secondary\"><i class=\"fa fa-angle-double-right\"></i></button></div></div></div></div></template>"; });
...
define('text!components/helper/page-title/page-title.html', ['module'], function(module) { module.exports = "<template><require from=\"./page-title.css\"></require><div class=\"page-title\"><div class=\"col-md-5\"><h2>${settings.content.title}</h2><compose containerless view-model=\"components/nav/breadcrumb/breadcrumb\"></compose></div><div class=\"col-md-7\"></div></div></template>"; });
define('text!components/helper/page-title/page-title.css', ['module'], function(module) { module.exports = "/**\n * @link http://www.color-hex.com/color-palettes/popular.php\n * @link http://www.color-hex.com/color-palette/185\n */\n.page-title {\n  border-bottom: 1px #dfe3ee solid;\n  margin: -20px -20px 0;\n  overflow: auto;\n}\n.page-title h2 {\n  color: #3b5998;\n}\n"; });
define('text!components/nav/breadcrumb/breadcrumb.html', ['module'], function(module) { module.exports = "<template><require from=\"./breadcrumb.css\"></require><ol class=\"breadcrumb\"><li repeat.for=\"route of routes\" class.bind=\"route.active ? 'breadcrumb__item--active' : ''\" class=\"breadcrumb__item\"><a route-href=\"route.bind: route.name; params.bind: route.params\">${route.title}</a></li></ol></template>"; });
define('text!components/nav/breadcrumb/breadcrumb.css', ['module'], function(module) { module.exports = "/**\n * @link http://www.color-hex.com/color-palettes/popular.php\n * @link http://www.color-hex.com/color-palette/185\n */\n.breadcrumb {\n  background: transparent;\n  font-size: 12px;\n  padding: 0;\n}\n.breadcrumb__item + .breadcrumb__item::before {\n  content: \"\\f105\";\n  font: normal normal normal 14px/1 FontAwesome;\n}\n.breadcrumb__item a {\n  color: #3b5998;\n}\n.breadcrumb__item a:hover {\n  text-decoration: none;\n}\n.breadcrumb__item--active a {\n  color: #8b9dc3;\n}\n"; });
