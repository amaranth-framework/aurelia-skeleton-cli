# Amaranth Framework - Aurelia Skeleton ([aurelia-cli](https://github.com/aurelia/cli))
...
You can now browse the skeleton app at http://localhost:9000 (or the next available port, notice the output of the command).
Changes in the code will automatically build and reload the app.

## Bundling

To build an optimized, minified production bundle (output to /scripts) execute:
...
> This section is still under @TODO status.
...
* [Adding Third Party Libraries To Aurelia Cli](http://arabsight.github.io/adding-third-party-libraries-to-aurelia-cli)
